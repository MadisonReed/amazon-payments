 ...
 * @type {Environment}
 */
exports.Sandbox.Notifications = new Environment('', 'https://pay-api.amazon.com/sandbox/v1/deliveryTrackers');
exports.Production.Notifications = new Environment('', 'https://pay-api.amazon.com/live/v1/deliveryTrackers');
exports.SandboxEU.Notifications = new Environment('', 'https://pay-api.amazon.eu/sandbox/v1/deliveryTrackers');
exports.ProductionEU.Notifications = new Environment('', 'https://pay-api.amazon.eu/live/v1/deliveryTrackers');
exports.SandboxJP.Notifications = new Environment('', 'https://pay-api.amazon.jp/sandbox/v1/deliveryTrackers');
exports.ProductionJP.Notifications = new Environment('', 'https://pay-api.amazon.jp/live/v1/deliveryTrackers');
